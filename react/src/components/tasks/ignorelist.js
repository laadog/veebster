...
const IgnoreList = () => {
  ...
  const handleDialogChoice = (choice) => {
    if(choice){
      selected.map(id =>{
        fetch(`https://veebster.tk/api/page/${pageId}/ignore/${id}`, {credentials: "include"})
      })
  ...
  function getData(){
    ...
    fetch(`https://veebster.tk/api/page/${pageId}/ignore`, {credentials: "include"}).then(res => res.json()).then((dataf)=>{
  ...
  const emptyRows =
    ...
    const handleCreateClose = (choice = false) => {
      if(choice){
        fetch(`https://veebster.tk/api/page/${pageId}/ignore`, {
          method: 'POST',
          mode: 'cors',
          credentials: "include",
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            Deleted ignore can overlap with other ignores.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
                ...
                .map((data, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell>{data.hitter || "All"}</TableCell>
                    </TableRow>
                  );
                })
